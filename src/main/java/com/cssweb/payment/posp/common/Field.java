...
public class Field {
    ...
    public void addField(Field common)
    {
        System.arraycopy(common.getFieldValue(), 0, fieldValue, common.getBeginPos(), common.getFieldLength());

        fields.put(common.getFieldName(), common);
    }*/
